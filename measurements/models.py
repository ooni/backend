...
TEST_GROUPS = {
    ...
    'circumvention': ['bridge_reachability', 'meek_fronted_requests_test', 'vanilla_tor', 'tcp_connect'],
    'legacy': ['http_requests', 'dns_consistency', 'http_host', 'multi_protocol_traceroute']
}
