...
RE_LOG_LINE = re.compile(r'^(?P<mon>Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) (?P<day>[0123]\d) (?P<hour>[0-2]\d):(?P<min>[0-5]\d):(?P<sec>[0-5]\d)\.[0-9]{3} (?P<msg>.*)$')
