...
class TestSlice(unittest.TestCase):
    ...
    def rpt(year):
        assert year < 10000
        return '{:04d}1231T065614Z-VN-AS24173-dns_consistency-no_report_id-0.1.0-probe.yaml'.format(year)
    ...
    def test_badname(self):
        ...
        self.assertRaises(RuntimeError, canning.pack_bucket, [('2013-05-05/'+self.REPORT, 42)])
