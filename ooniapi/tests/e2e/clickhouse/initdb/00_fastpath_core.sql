...
-- Added for the e2e harness: needed by oonimeasurements' /api/v1/detector/changepoints
-- endpoint. Copied from ooniapi/services/oonimeasurements/tests/migrations/0_clickhouse_init_tables.sql
